...
<head>
    ...
    <title>ADMIN | Arsip Surat Desa Karangduren</title>
    <!-- Favicon-->
...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);"><b>Arsip Surat Desa Karangduren</b></a>
            <br>
            ...
            <div class="body">
                <form id="sign_in" action="{{route('login')}}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <button class="btn btn-block bg-grey waves-effect" type="submit">Masuk</button>
                        </div>
                    </div>
