                    ...
                    <div class="body">
                        <form enctype="multipart/form-data" method="POST" action="{{url('admin/surat/create')}}">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="nama_kegiatan" class="form-control" placeholder="Nomor Surat" name="nomor" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="nama_kegiatan" class="form-control" placeholder="Judul Surat" name="judul" required>
                                </div>
                            <label for="file_kebijakan">FILE</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="file" name="file" id="nis" class="form-control" placeholder="file kebijakan" required>
                                </div>
                            </div>
